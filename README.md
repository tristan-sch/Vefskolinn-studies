# Vefþróun | Tækniskólinn | 2021-2022
...
- 👨‍💻 [Live site on Github](https://tristan-sch.github.io/hello-sass/)

2. HTML & CSS - Tooling/Bootstrap

- 👉 One page in `html` and [bootstrap](https://getbootstrap.com/)
- 👨‍💻 [Live site on Github](https://tristan-sch.github.io/hello-bootstrap)
...
- 👨‍💻 [Preview on Replit](https://replit.com/@tristan-sch1/34-Javascript-Introduction-Functions#index.js)

7. Javascript In The Browser - DOM Manipulation & Timing

- 👉 Added `javascript` into my first website below
- 👨‍💻 [Live site on Github](https://tristan-sch.github.io/hello-dom/)

8.  Design - UI Fundamentals

- 👉 Started creating `UI design` for a travel agency website
- 👨‍💻 [Preview on Figma](https://www.figma.com/file/7O384hE5LWOlv8eP0xUTQN/Design---UI-Fundamentals?node-id=0%3A1)

9. Design - UI Redesign

- 👉 Redid a restaurant's website
- 👨‍💻 [Preview on Figma](https://www.figma.com/file/YzrJn4FYKkJrt4DP0uYMLu/Design---UI-Redesign?node-id=0%3A1&t=NyFv1us8dUQndXt4-0)

10. Design - UI Accessibility

- 👉 Simple HTML page structured to the `Accessibility` guidelines with a report

- 👨‍💻 [Live site on Github](https://tristan-sch.github.io/hello-accessibility/)

11. Design - UI Design System

- 👉 Started creating a `design system` for a travel agency website
- 👨‍💻 [Preview on Figma](https://www.figma.com/file/UZvRBsLBbBPICrp4t56L7q/AD-Travel---Design-system?t=3ag7HVTiotg4ywym-0)
...
- 👨‍💻 [Live site on Github](https://tristan-sch.github.io/hello-forms/)

13. Javascript In The Browser - Common Web APIs
...
- 👨‍💻 [Live site on Github](https://tristan-sch.github.io/hello-APIs/)
...
- 👉 An interactive and responsive Web Application displaying random questions and results
...
- 👨‍💻 [Glitch preview](https://glitch.com/edit/#!/hello-animation-transformation-?path=README.md%3A1%3A0)

2. Javascript - API Consumption & React

- 👉 I created a simple Weather App. For this I used these APIs
- 👨‍💻 [Live site on Github](https://tristan-sch.github.io/hello-react/)
...
- 👨‍💻 [Live site on Vercel](https://hello-functional-programming.vercel.app/)

6. Design - Design Sprint
...
- 👨‍💻 [Live site on Vercel](https://mern-app-vercel.vercel.app/)
...
- 👉 User Research, Scenarios & Storyboarding, Interaction Design, Gestalt theory, Micro Interactions & User Feedback for **leftover food app**
...
- 👨‍💻 [Live site on Vercel](https://lightswitch-one.vercel.app/)
